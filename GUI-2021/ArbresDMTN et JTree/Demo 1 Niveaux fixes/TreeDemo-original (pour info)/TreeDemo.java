...
public class TreeDemo extends JPanel
    ...
    public void valueChanged(TreeSelectionEvent e) {
        ...
        if (node == null) return;
//.getUserObject() récupère l'info sur le noeud (ici une instance de BookInfo)
//à condition qu'on ait cliqué sur une feuille
    ...
    private class BookInfo {
        ...
        public String toString() { //sert à l'affichage du JTree
            //return bookName;
    ...
    private void createNodes(DefaultMutableTreeNode top) {
        ...
        category = new DefaultMutableTreeNode("Livres Java en français");
        top.add(category);
        
        book = new DefaultMutableTreeNode(new BookInfo("Java 2 : notions fondamentales", ""));
        category.add(book);
